...
import 'package:flutter_deer/generated/json/approval_entity_helper.dart';
...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {
			...
			case ApprovalEntity:
				return approvalEntityFromJson(data as ApprovalEntity, json) as T;
			case ApprovalItems:
				return approvalItemsFromJson(data as ApprovalItems, json) as T;
			case UserEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {
			...
			case ApprovalEntity:
				return approvalEntityToJson(data as ApprovalEntity);
			case ApprovalItems:
				return approvalItemsToJson(data as ApprovalItems);
			case UserEntity:
  ...
  //Go back to a single instance by type
	static _fromJsonSingle<M>( json) {
		...
		}	else if(type == (ApprovalEntity).toString()){
			return ApprovalEntity().fromJson(json);
		}	else if(type == (ApprovalItems).toString()){
			return ApprovalItems().fromJson(json);
  ...
  //list is returned by type
	static M _getListChildType<M>(List data) {
		...
		}	else if(<ApprovalEntity>[] is M){
			return data.map<ApprovalEntity>((e) => ApprovalEntity().fromJson(e)).toList() as M;
		}	else if(<ApprovalItems>[] is M){
			return data.map<ApprovalItems>((e) => ApprovalItems().fromJson(e)).toList() as M;
